  ...
  return (
    <main className="bg-canvas text-ink">
      ...
      <SectionIntroFeatureGrid
        ...
        intro="As Canada's only certified, embedded conversation-capture platform for Applied Epic, we capture calls, texts, and voicemails as they happen. Stop relying on thin, manually typed notes that put you at risk for E&O claims two years down the line. Our platform closes the gap between the conversation and the record, giving your brokerage a searchable and defensible file without the manual data entry."
